...
const color = Object.keys(colors.names);
...
const sketch = () => {
  return ({ context, width, height }) => {
    my_gradient = context.createLinearGradient(0, 0, 0, 170);
    my_gradient.addColorStop(.0001, "transparent");
    ...
    for ( let i = 0; i < num; i ++) {
      ...
      context.scale(random.range(.1, 2), range(.2, 5));
